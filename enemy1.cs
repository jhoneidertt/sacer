...
namespace SpaceWar
{
    ...
    class enemy1
    {
        ...
        public enemy1(Game1 _root)
        {
            //initialize a values
            this.root = _root;
            Size = 200;
            velocity = new Point(30, 0);
            position = new Point(this.root.Window.ClientBounds.Width - Size, 700);
        ...
        public enemy1(Game1 _root, Point _position)
        {
            //initialize values
            this.root = _root;
            Size = 200;
